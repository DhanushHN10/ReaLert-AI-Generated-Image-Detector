...
base_model = AutoModelForImageClassification.from_pretrained(
    "facebook/deit-base-patch16-224", 
    num_labels=6,
    ignore_mismatched_sizes=True  # Correctly ignores the old 1000-label head
)

# This path must match the SAVE_DIR from your train.py
adapter_save_path = "./AI-Generated-Image-Detector-Model"
...
# --- This is the new, critical part that loads the trained head ---
...
try:
    ...
    exit() # Stop the script if the head isn't found
